*==============================================================================*
*  xtpraisk simulation study -- Do-file 2: AR(2) primary
*
*  PRIMARY:
*    xtpraisk lag(2)  vs  xtscc lag(2)   [DGP=AR(2), fit=AR(2)]
*    3 scenarios x 3 N x 6 T x 4 b1 = 216 conditions
*
...
*==============================================================================*
*  PRIMARY: DGP=AR(2), both estimators use lag(2)
*==============================================================================*
...
postfile sim_res          ///
    ...
    int    T_periods      ///
    double b1_true        ///
    int    method         ///  1=xtpraisk lag(2)  2=xtscc lag(2)
    double reject         ///
    double coverage       ///
    double pct_bias       ///
    double rmse           ///
    double se_ratio       ///
    using "C:\Users\Ariel\Desktop\ITSA_stuff\xtprais\xtpraisk_sim_ar2.dta", replace
...
foreach scen of numlist 1/3 {
    ...
    * Galbraith & Galbraith (1974) stationary variance matrix elements
    ...
    foreach b1 of numlist `b1_list' {
        ...
        di as txt _newline ///
            "AR(2) Primary  Scen=`scen' rho=(`rho1',`rho2')  N=`N'  T=`T'  b1=`b1'"
...
use "C:\Users\Ariel\Desktop\ITSA_stuff\xtprais\xtpraisk_sim_ar2.dta", clear
label define scen_lbl 1 "Mild positive (0.4, 0.2)"  ///
                      2 "Oscillatory (0.5, -0.4)"   ///
                      3 "High persistent (0.7, 0.2)"
label define meth_lbl 1 "xtpraisk lag(2)" 2 "xtscc lag(2)"
...
save "C:\Users\Ariel\Desktop\ITSA_stuff\xtprais\xtpraisk_sim_ar2.dta", replace

di as txt _newline "Do-file 2 (AR(2) primary) complete."
